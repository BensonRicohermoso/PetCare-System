...
public class PetCareSystem {
    ...
    private static void displayMenu() {
        System.out.println(
                BLUE + "┌─────────────────────────────────────────────────────────────────────────────┐" + RESET);
        System.out.println(BRIGHT_CYAN + "│  " + YELLOW + "PetCare Menu" + BRIGHT_CYAN
                + "                                                               │" + RESET);
        System.out.println(
                BLUE + "│─────────────────────────────────────────────────────────────────────────────│" + RESET);
        System.out.println(BRIGHT_CYAN + "│ " + GREEN + "1." + YELLOW + "Create Record" + BRIGHT_CYAN
                + "                                                             │" + RESET);
        System.out.println(BRIGHT_CYAN + "│ " + GREEN + "2." + YELLOW + "View All Records" + BRIGHT_CYAN
                + "                                                          │" + RESET);
        System.out.println(BRIGHT_CYAN + "│ " + GREEN + "3." + YELLOW + "Update Record" + BRIGHT_CYAN
                + "                                                             │" + RESET);
        System.out.println(BRIGHT_CYAN + "│ " + GREEN + "4." + YELLOW + "Delete Record" + BRIGHT_CYAN
                + "                                                             │" + RESET);
        System.out.println(BRIGHT_CYAN + "│ " + GREEN + "5." + RED + "Exit" + BRIGHT_CYAN
                + "                                                                      │" + RESET);
        System.out.println(
                BLUE + "└─────────────────────────────────────────────────────────────────────────────┘" + RESET);
    }
    ...
    private static void readRecords() {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(FILE_NAME))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                System.out.println(CYAN + "Pet: " + RESET + WHITE + data[0] + GREEN + " (" + data[1] + ", " + data[2]
                        + " yrs)" + RESET);
